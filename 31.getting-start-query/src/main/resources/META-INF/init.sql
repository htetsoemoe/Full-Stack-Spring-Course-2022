...
insert into category(name) values('Fashions');
...
insert into product(name, category_id, price, availabel) values('Potato Chips', 1, 500, true);
insert into product(name, category_id, price, availabel) values('Jelly', 1, 300, true);
insert into product(name, category_id, price, availabel) values('Hand Cream', 4, 500, true);-- Category
