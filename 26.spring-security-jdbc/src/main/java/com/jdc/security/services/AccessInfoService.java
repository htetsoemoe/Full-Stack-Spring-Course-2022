...
public class AccessInfoService {
	...
	public void create(String loginId, Type type) {
		if (!"admin".equals(loginId)) {
			accessInfoInsert.execute(Map.of("login_id", loginId, "type", type));
		}
	}
	
	// This method used in Member's home view for member access log
	...
	// This method used in Admin's home view for All Member (Admin and Members) access log
